...
urlpatterns = [
    ...
    path('category/<path:category_name>/', views.article, name='articles'),
    path('category/<path:category_name>/peage/<int:page_number>/', views.article, name='articles_pagination'),
